...
const SortedProducts = () => {
	...
	return (
		<div className='mb-8 lg:mb-16 space-y-5 sm:space-y-6 mt-8 lg:mt-4'>
			<h3 className='font-bold text-xl sm:text-2xl md:text-3xl text-center lg:text-start tracking-tight'>
							...
							<div className='w-full items-center flex justify-between'>
								<div className='flex items-center gap-3'>
									<Link
										...
										className='text-lg sm:text-xl md:text-2xl font-medium tracking-tight text-primaryColor-400 whitespace-nowrap'
									/>
									<div className='size-6 bg-slate-950 text-sm text-white rounded-md grid place-items-center'>
										<h4>{index + 1}</h4>
									</div>
								</div>
								<Link
