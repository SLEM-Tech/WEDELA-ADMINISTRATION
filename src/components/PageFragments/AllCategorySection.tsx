      ...
      <section className="flex flex-col-reverse lg:grid grid-cols-1 lg:grid-cols-10 items-center px-6 gap-6 min-h-screen bg-white relative overflow-hidden">
        ...
        <div className="lg:col-span-4 z-10 text-black space-y-2 lg:space-y-4 h-full flex flex-col justify-center">
          <h3 className="font-bold text-3xl sm:text-4xl md:text-5xl lg:text-6xl tracking-tight leading-tight md:leading-8">
            ...
            <br />
            Off Our Elegant Collections
          </h3>

          <p className="text-base md:text-lg lg:text-xl leading-7 text-gray-600 max-w-md">
            Our curated collection features premium clothing and accessories
            that blend contemporary design with timeless sophistication. Express
            your unique style with pieces crafted for the discerning fashion
            enthusiast.
          </p>

          <div
            onClick={() => router.push("/category")}
            className="flex items-center gap-2 lg:gap-4 pt-2 lg:pt-4"
          >
            <Picture
              src="/images/sampleimg.webp"
              alt="phone sample"
              className="size-16 lg:size-24 rounded-xl object-contain cursor-pointer"
            />
            <div>
        ...
        <div className="lg:col-span-6 relative flex justify-center lg:justify-end items-center h-full">
          ...
          <Picture
            src="/images/femimg.jpg"
            alt="iPhone"
            className="relative z-10 w-[80%] lg:w-[50%] object-cover object-center rounded-l-md"
          />
          <Picture
            src="/images/heroimage.jpg"
            alt="iPhone"
            className="relative z-10 w-[80%] lg:w-[50%] object-cover object-center rounded-r-md"
          />
