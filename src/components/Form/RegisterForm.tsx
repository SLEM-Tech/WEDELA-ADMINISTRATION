	...
	return (
		<>
			<div className='flex flex-col bg-white w-full max-w-[32rem] pt-3 pb-5 md:pb-10 px-3 md:px-10 shadow-lg rounded-xl'>
				<h4 className='text-base md:text-2xl uppercase font-medium text-center'>
					Register
				</h4>
					...
					<Form className='flex flex-col gap-2 md:gap-3'>
						<div>
							...
							<Field
								...
								className={`w-full px-2 py-2 placeholder:text-gray-500 md:py-3 font-[400] text-xs md:text-sm rounded-md border border-secondary-800 outline-none focus:border-secondary-800 transition-[.5] ease-in ${
