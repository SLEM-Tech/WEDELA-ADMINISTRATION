				...
				<Form className='flex flex-col gap-2 md:gap-4'>
					<div>
						...
						<Field
							...
							className={`w-full px-2 py-2 md:py-3 placeholder:text-gray-500 text-xs md:text-sm rounded-md border border-secondary-800 outline-none transition-[.5] ease-in focus:border-transparent focus:ring-1 focus:ring-primaryColor-100 ${
					...
					<div>
						<label
							htmlFor='password'
							className='block text-xs md:text-base text-secondary-400 mb-1'
						>
						...
						<div className='relative'>
							<Field
								...
								className={`w-full px-2 py-2 md:py-3 placeholder:text-gray-500 text-xs md:text-sm rounded-md border border-secondary-800 outline-none focus:border-transparent transition-[.5] ease-in focus:ring-1 focus:ring-primaryColor-100 ${
					...
					<button
						type='submit'
						className={`flex items-center justify-center border relative bg-black2-100 text-white border-transparent hover:border-dark hover:bg-dark hover:text-white hover:border-transparent text-xs sm:text-sm leading-[1.4] font-semibold py-2.5 sm:py-3 w-full rounded-md gap-1.5 transition ${
							formik.isValid
